    ...
    return (
      <>
        <div className="buttons d-flex justify-content-center mb-3 pb-3">
          ...
          <div
            className="btn btn-outline-dark me-2"
            onClick={() => handleFilter('Chaussure')}
          >
            Chaussure
          </div>
          <div
            className="btn btn-outline-dark me-2"
            onClick={() => handleFilter('Fleur')}
          >
            Fleur
          </div>
          <div
        ...
        <motion.div layout>
          <div className="row">
            {filter?.map((product) => {
              return (
                <motion.div layout className="col-md-3 my-2" key={product.id}>
      ...
      <div className="container my-5 py-3">
        <div className="row">
          <div className="col-12">
            <h1 className="display-6 fw-bolder text-center my-4">
              Latest Products
            </h1>
            <hr />
          </div>
