        ...
        <div className="container">
            <div className="row">
                ...
                <div className="col-md-8 mx-auto">
                        ...
                        <tbody>
                            {currentPosts?.map((contact) => (
                                <tr key={contact.id}>
                                    ...
                                    <td><Link to={`/edit/${contact.id}`} className="btn btn-success">Update</Link></td>
                    ...
                    <Pagination postsPerPage={postPerPage} totalPosts={contacts?.length} paginate={paginate} nextPage={nextPage} prevPage={prevPage} />
                </div>
            </div>
